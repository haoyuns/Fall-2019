...
#### 色彩搭配思路
- **单色** Monochromatic  
<img src="{{site.baseurl}}/images/c-mono.jpeg">

- **类似** Analogous  
色轮上彼此相邻的颜色组成  
<img src="{{site.baseurl}}/images/c-analogous.jpeg" width="600">

- **互补** Complementary  
色轮中完全对立的颜色为互补色  
<img src="{{site.baseurl}}/images/c-complementary.jpeg" width="800">

- **等边互补** Split Complementary  
选择一种颜色，再在色轮上找出它正对面的互补色；  
不直接使用这个互补色，而是使用该互补色两侧的颜色
<img src="{{site.baseurl}}/images/c-split.jpeg" width="750">
